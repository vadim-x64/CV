...
const PROJECTS: Project[] = [
    {
        ...
        title: 'TopKidGame',
        description: 'Інтерактивна головоломка "П\'ятнашки", реалізована на JavaScript, підійде для дітей і дорослих. Має дружній мультяшний інтерфейс, музику на фоні та базові налаштування для комфортної гри. Сприяє розвитку логічного мислення й може слугувати як розвага, так і антистрес. Також адаптовано під телефон.',
        link: 'https://topkidgame.onrender.com',
    },
    {
        img: '/images/todo.png',
        title: 'SmartToDo',
        description: 'Вебсистема для управління завданнями, яка допомагає організувати особисті та робочі справи в одному місці. Дозволяє створювати завдання, встановлювати терміни виконання, розподіляти їх по категоріях та отримувати нагадування про події. Застосунок написаний на JavaScript і має зручний інтерфейс для швидкого планування щоденних справ.',
        link: '',
    },
    {
        img: '/images/chatbot.png',
        title: 'Chatbot',
        description: 'Простий інформаційно-навчальний бот на Java. Спрямований на тих, хто цікавиться автомобілями, вчиться в автошколі та простих автолюбителів. Надає короткі довідки про принцип роботи, основи керування, будову авто, техніку управління, категорії ТЗ, марки, історію.',
        link: 'https://chatbot-ftcs.onrender.com',
    },
    {
        img: '/images/autoservice.png',
        title: 'TireVault',
        description: 'Вебсистема для автосервісу, написана на Java Spring. Клієнти можуть онлайн записатися на технічне обслуговування або ремонт, переглядати перелік послуг і купувати автозапчастини в інтегрованому магазині. Передбачено особистий кабінет із історією записів і замовлень, а також відгуки на виконані роботи.',
        link: 'https://tirevault.onrender.com',
    },
    {
        img: '/images/blog.png',
        title: 'MyBlog',
        description: 'Вебплатформа для ведення блогу, реалізована на .NET. Користувачі можуть реєструватися, створювати та редагувати власні пости, прикріплювати зображення. Передбачена система коментарів для обговорення публікацій та лайки для оцінки контенту. Адміністрація здійснює модерацію дописів і може блокувати порушників правил спільноти.',
    },
    {
        img: '/images/media.png',
        title: 'MediaApp',
        description: 'Десктопний застосунок на .NET WPF, який автоматично знаходить дублікати фото та відео на комп\'ютері. Аналізує якість файлів і дозволяє швидко видалити зайві копії, залишаючи найкращі. Ефективний інструмент для звільнення непотрібних медіафайлів та впорядкування медіатеки. Працює тільки під керуванням Windows.',
    }
]
            ...
            <main>
                ...
                <div className="home-footer-section">
                    ...
                    <div className="social-links-blocks">
                        <a href="https://github.com/vadim-x64" target="_blank" rel="noreferrer" className="social-btn">
                            GitHub
                        </a>
                        <a href="https://www.linkedin.com/in/%D0%B2%D0%B0%D0%B4%D0%B8%D0%BC-%D0%B2%D0%BE%D0%B9%D1%86%D0%B5%D1%85%D0%BE%D0%B2%D1%81%D1%8C%D0%BA%D0%B8%D0%B9-623868300/?lipi=urn%3Ali%3Apage%3Ad_flagship3_profile_view_base_contact_details%3BDggACzrERfy6nZQkdqhi7w%3D%3D" target="_blank" rel="noreferrer" className="social-btn">
                            LinkedIn
                        </a>
                    </div>
                </div>
